...
// Module 11: form POSTs id + amount + color to cart_add.php
// ============================================
  ...
  <div class="grid gap" style="margin-top: 3rem;">
    ...
    <div class="col-12 col-md-6 product-details">
      ...
      <div class="price-section">
        ...
        <span class="addon-price">Trainer pot included · Ceramic +$45</span>
      </div>

      <!-- ADD TO CART FORM (Module 11) -->
      <form action="cart_add.php" method="POST">
        <input type="hidden" name="id" value="<?= $id ?>">

        <div class="form-row" style="margin-top: 1.5rem;">
          <label style="display:block; margin-bottom:0.5rem;">Planter Option</label>
          <label style="display:flex; align-items:center; gap:0.5rem; cursor:pointer; padding:0.4rem 0;">
            <input type="radio" name="planter_option" value="trainer" checked>
            <span>Trainer Pot — included <em style="color:#777;">(free)</em></span>
          </label>
          <label style="display:flex; align-items:center; gap:0.5rem; cursor:pointer; padding:0.4rem 0;">
            <input type="radio" name="planter_option" value="ceramic">
            <span>Ceramic Planter (as shown) — <strong>+$45</strong></span>
          </label>
        </div>
        ...
        <div class="form-row" style="margin-top: 1rem;">
          <label for="amount" style="display:block; margin-bottom:0.5rem;">Quantity</label>
          <input type="number" name="amount" id="amount" value="1" min="1" class="input-hotdog">
        </div>

        <button type="submit" class="btn-primary btn-full" style="margin-top: 1.5rem;">Add to Cart</button>
      </form>
