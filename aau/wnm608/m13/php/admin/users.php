...
<body>
  <div class="admin-header">
    ...
    <div style="display:flex;gap:1rem;align-items:center;">
      <a href="product_admin.php" style="color:#aaa;text-decoration:none;font-size:0.85rem;">Products</a>
      <a href="users.php" style="color:#fff;text-decoration:none;font-size:0.85rem;">Users</a>
      <a href="../index.php" style="color:#aaa;text-decoration:none;font-size:0.85rem;">&larr; Back to Site</a>
    </div>
  </div>
